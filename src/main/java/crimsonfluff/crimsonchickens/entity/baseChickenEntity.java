...
public class baseChickenEntity extends AnimalEntity {
    ...
    public baseChickenEntity(EntityType<? extends baseChickenEntity> type, World worldIn) {
        super(type, worldIn);
...
//        return entity;
    ...
    public void readAdditional(CompoundNBT compound) {
        ...
        if (compound.contains("EggLayTime")) this.timeUntilNextEgg = compound.getInt("EggLayTime");
...
//        float f3 = 0.0F;
     ...
     */
    public void setChickenJockey(boolean jockey) { this.chickenJockey = jockey; }
}
